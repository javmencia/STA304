...
kable(
  ...
  align = "c", 
  caption = "Survey-Weighted Logistic Regression Results"
) %>%
  kable_styling(latex_options = c("striped", "hold_position")) %>%
...
To better interpret these log-odds, I exponentiated the coefficients. Holding age constant, the odds of voting Liberal for males are exp(-0.239) ≈ 0.787 times the odds for females, confirming that males have a lower probability of voting Liberal. Similarly, for each additional year of age, the odds of voting Liberal increase by exp(0.011) ≈ 1.011 times, meaning that older individuals are slightly more likely to vote Liberal. Overall, Table 2 confirms that females are more likely to vote Liberal than males, and that age is positively associated with supporting the Liberal party.

# 5 Discussion

The objective of this study was to assess whether women were more likely to vote for the Liberal Party in the 2019 Canadian Federal Election. The principal findings indicate that women had 27% higher odds of voting Liberal compared to men, supporting our initial hypothesis. A key strength of the study is its use of stratified random sampling, which improves representativeness across gender groups. The findings suggest potential mechanisms, such as gender differences in political ideology, that may explain the observed voting patterns. These results have implications for policymakers and political analysts in understanding gender-based electoral trends.
...
For this assignment, AI tools (OpenAI, 2025) were used to assist with the structuring our analysis and explanations. AI helped us draft and make us understand about on potential biases introduced by phone and web surveys. Additionally, we used AI to format visualizations, synthesize our initial draft before rewriting, and correct grammar to enhance readability.

However, all analytical processes, statistical modeling, interpretations, and conclusions were entirely our own. To ensure that the final work reflected our understanding of the course material, we carefully reviewed and edited all AI-assisted sections, cross-referenced them with course readings, class notes, and our knowledge from previous courses. By doing so, we maintained the integrity of our work while leveraging AI for structure and clarity.
